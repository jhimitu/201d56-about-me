...
document.getElementById('start-quiz').addEventListener('click', () => {
  ...
  while ((stateLivedInAnswer !== states[0] || stateLivedInAnswer !== states[1]) && triesUsed < availableGuesses) {
    stateLivedInAnswer = prompt('Can you guess what states I have lived in besides Washington? You have 6 guesses.').toLowerCase();
    triesUsed++;
    ...
    console.log(triesUsed + ' ' + stateLivedInAnswer);
  }
});
