...
document.getElementById('start-quiz').addEventListener('click', () => {
  ...
  } else if (morningPersonAnswer === 'no') {
  ...
  } else if (cheesyDanceMovieAnswer === 'no') {
    alert('Sorry, that\'s incorrect.');
  }
  ...
  } else if (playsInstrumentAnswer === 'no') {
    alert('Sorry, that\'s incorrect.');
  }
